...
def pridobi_stran(valuta, leto):
    #Pošlje zahtevek na stran in shrani surov HTML odgovor v datoteko
...
def pridobi_vse_strani():
    #Pridobi in shrani surove HTML-je, strani za vse valute in vsa leta
